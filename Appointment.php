...
$appt_del_query = "SELECT * FROM `appointment`";
	
$appt_del_query_prepare = $connection->prepare($appt_del_query);


$appt_del_query_prepare->execute();

$appt_tab = $appt_del_query_prepare->fetchAll(PDO::FETCH_ASSOC);
               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="Appointment.php"> Appointment Detail</a>
                        </li>
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-header">
                        <h5 class="card-header-text">Appointment Details</h5>
                        ...
                        <div class="row">
                           <div class="col-sm-12 table-responsive">
                              <table class="table">
                                 ...
                                 <tbody>
                                    <?php foreach($appt_tab as $appt){ ?>
                                    <tr>
                                       <td><?= $appt['user_id'] ?></td>
                                    <td><?php echo $appt['appointment_id']; ?></td>
                                    <td><?php echo $appt['name']; ?></td>
                                    
                                    <td><?php echo $appt['date_of_birth']; ?></td>
                                    <td><?php echo $appt['gender']; ?></td>
                                    <td><?php echo $appt['vaccine']; ?></td>
                                    <td><?php echo $appt['preferred_appointment_date']; ?></td>
                                    <td><?php echo $appt['preferred_appointment_time']; ?></td>
                                    <td> <button type="button" class="btn btn-primary waves-effect waves-light" data-toggle="tooltip" data-placement="top" title=".btn-primary">Primary
                                </button> </td>
                                <td> <button type="button" class="btn btn-danger waves-effect waves-light " data-toggle="tooltip" data-placement="top" title=".btn-danger">danger
                                </button> </td>
