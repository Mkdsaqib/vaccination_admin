                     ...
                     <div class="card">
                        ...
                        <div class="card-block">
                           <form action='Add-Hospital.php' method='post' enctype="multipart/form-data">
                              <div class="form-group row">
                                 <label for="example-text-input" class="col-xs-2 col-form-label form-control-label">Child Name</label>
                                 <div class="col-sm-10">
                                    <input class="form-control" name="hospital_name" type="text" id="example-text-input">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-search-input" class="col-xs-2 col-form-label form-control-label">Father Name</label>
                                 <div class="col-sm-10">
                                    <input class="form-control" name="address" type="search" id="example-search-input">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-email-input" class="col-xs-2 col-form-label form-control-label">Age</label>
                                 <div class="col-sm-10">
                                    <input class="form-control" name="email" type="email" id="example-email-input">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-gender-input" class="col-xs-2 col-form-label form-control-label">Gender</label>
                                 <div class="col-sm-10">
                             ...
                             <div class="form-check form-check-inline">
                              ...
                              <div class="form-group row">
                                 <label for="example-date-picker-input" class="col-xs-2 col-form-label form-control-label">Date of Vaccination</label>
                                 <div class="col-sm-10">
                                 <input type="date" id="datemin" name="date" min="2023-24-10"><br>
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-Time-input" class="col-xs-2 col-form-label form-control-label">Time of Vaccination</label>
                                 <div class="col-sm-10">
