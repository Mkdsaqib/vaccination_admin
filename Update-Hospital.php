...
// $File_input = $_POST['img'];
  ...
  $sql = "UPDATE `vaccination` SET `hospital_name`='$hospital_name',`address`='$Address',`email`='$Email',`url`='$URL',`telephone`='$Telephone',`password`='$Password',`description`='$Description' WHERE id = $id";

  $result = mysqli_query($connection, $sql);

  if ($result) {
    header("Location: Add-hospital.php?msg=Data updated successfully");
  } else {
...
$hosp_del_query = "UPDATE * FROM `hosp-reg`";
                        ...
                        <div class="card-block">
                           <form action='Add-Hospital.php' method='post' enctype="multipart/form-data">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-10">
                                    <input class="form-control" name="hospital_name" value="<?php echo $row['hospital_name'] ?>" type="text" id="example-text-input">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-search-input" class="col-xs-2 col-form-label form-control-label">Address</label>
                                 <div class="col-sm-10">
                                    <input class="form-control" name="address" value="<?php echo $row['address'] ?>" type="search" id="example-search-input">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-email-input" class="col-xs-2 col-form-label form-control-label">Email</label>
                                 <div class="col-sm-10">
                                    <input class="form-control" name="email" value="<?php echo $row['email'] ?>" type="email" id="example-email-input">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-url-input" class="col-xs-2 col-form-label form-control-label">URL</label>
                                 <div class="col-sm-10">
                                    <input class="form-control" name="url" value="<?php echo $row['url'] ?>" type="url" id="example-url-input">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-tel-input" class="col-xs-2 col-form-label form-control-label">Telephone</label>
                                 <div class="col-sm-10">
                                    <input class="form-control" name="telephone" value="<?php echo $row['telephone'] ?>" type="tel" id="example-tel-input">
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-password-input" class="col-xs-2 col-form-label form-control-label">Password</label>
                                 <div class="col-sm-10">
                                    <input class="form-control" name="password" value="<?php echo $row['password'] ?>" type="password" id="example-password-input" >
                                 </div>
                              </div>
                              <div class="form-group row">
                                 <label for="example-Description-input" class="col-xs-2 col-form-label form-control-label">Description</label>
                                 <div class="col-sm-10">
                                    <input class="form-control" name="description" value="<?php echo $row['description'] ?>" type="Text" id="example-Despcription-input" >
                                 </div>
                              </div>
