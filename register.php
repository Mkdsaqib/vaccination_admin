			...
			<div class="row">
					<div class="col-sm-12">
						<div class="login-card card-block bg-white">
							<form class="md-float-material" action="register.php" method="post">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="md-input-wrapper">
											<input name="firstName" type="text" class="md-form-control" required="">
											<label>First Name</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="md-input-wrapper">
											<input name="lastName" type="text" class="md-form-control" required="">
